<template>
  <div class="pl20">
    <div class="search-border">
      <p><span class="blueBox"></span>项目通报</p>
    </div>
    <el-table :data="tableData" :height="windowHeight"  style="width: 100%" v-loading="loading" element-loading-text="拼命加载中..." element-loading-spinner="el-icon-loading">
...
<script type="text/ecmascript-6">
  ...
  import {xmBulletin} from '@/api/gtzz/gtzz'
  export default{
    props:{},
    components:{
      Page
    ...
    methods:{
      getTable(){
        this.loading = true;
        xmBulletin(this.queryParams).then(response =>{
